...
use rustnomial::{poly_add, poly_mul, Monomial, Polynomial, SparsePolynomial, LinearBinomial};

fn main() {
    let mut a = Polynomial::new(vec![1]);
    poly_mul!(Monomial::new(5, 1), Monomial::new(1, 2), Monomial::new(1, 2); a);
    println!("{}", a);
}
